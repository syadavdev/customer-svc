insert into `customer` (`customer_id`, `first_name`, `last_name`, `customer_name`, `password`, `phone_number`, `email`, `country`) values ( 1, 'Sandeep', 'Yadav', 'syadavdev', '$2a$04$wYagTuKZoKQyvAMlOwnlseVD.WiOOUROnjGCHm7xQhJrI5shv/9Du', '9729933490', 'sandi@gmail.com', 'india');
